...
<div class="card mb-3" style="padding-top: 2cm;">
  <img class="card-img-top" src="motog5s.jpg" alt="Card image cap" >
  <div class="card-block">
    <h2 class="card-title">Moto G5 Plus</h2>
    <ul>
    	         <li><p style="font-size: 15px">5.2 inch Full HD Display</p></li>
                      <li><p style="font-size: 15px">12MP Primary Camera | 5MP Front</p></li>
                      <li><p style="font-size: 15px">3000 mAh Battery | Snapdragon 625 Processor</p></li>
 ...
 <h3 style="font-family: Ubuntu, sans-serif; font-size: 18px"> Price:<i class="fa fa-inr"></i> 16,999</h3>
