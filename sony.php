...
<div class="card mb-3" style="padding-top: 2cm;">
  <img class="card-img-top" src="xa.jpg" alt="Card image cap" >
  <div class="card-block">
    <h2 class="card-title">Sony Xperia XA Dual</h2>
    <ul>
    	<li><p style="font-size: 15px">5 inch HD Display</p></li>
                      <li><p style="font-size: 15px">2300 mAh Li-Ion Battery|MediaTek Helio P10 64-bit Processor</p></li>
                      <li><p style="font-size: 15px">13MP Primary Camera | 8MP Front</p></li>

    </ul>
    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
  </div>
</div>
 <h3 style="font-family: Ubuntu, sans-serif; font-size: 18px;"> Price:<i class="fa fa-inr"></i> 15,990</h3></center>
